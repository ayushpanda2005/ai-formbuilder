...
import { RWebShare } from 'react-web-share'
 ...
 function FormListItem({jsonForm,formRecord}) {
    const {user} = useUser()
   ...
   return (
     ...
     <div className='border shadow-sm roumded-lg p-4'>
        <div className='flex justify-between'>
            <h2></h2>
            
            <AlertDialog>
  <AlertDialogTrigger asChild><Trash className='h-5 w-5 text-red-600 cursor-pointer
  ...
  <AlertDialogContent>
    ...
    <AlertDialogFooter>
      ...
      <AlertDialogAction onClick={()=>onDeleteForm()}>Continue</AlertDialogAction>
         ...
         <h2 className='font-bold text-black text-lg'>{jsonForm.formTitle}</h2>
         <h2 className='font-bold text-white text-lg'>{jsonForm.formHeading}</h2>
